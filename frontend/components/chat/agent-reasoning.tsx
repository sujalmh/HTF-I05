  ...
  return (
    <div className="space-y-4 w-full">
      ...
      <Tabs defaultValue="explanation" className="w-full">
        ...
        <TabsContent value="explanation" className="bg-white p-4 rounded-lg border">
        ...
        <TabsContent value="results" className="bg-white p-4 rounded-lg border w-full">
          <div className="overflow-auto max-h-[400px] max-w-[820px]">
            <DataTable data={reasoning.tableData} columns={reasoning.tableColumns} />
          </div>
        </TabsContent>

        <TabsContent value="visualization" className="bg-white p-4 rounded-lg border">
